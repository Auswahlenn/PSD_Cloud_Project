...
\bibitem{kubernetes2018} B. Burns, B. Grant, D. Oppenheimer, E. Brewer, and J. Wilkes, ``Borg, Omega, and Kubernetes,'' \textit{Communications of the ACM}, vol. 59, no. 5, pp. 50--57, 2018. Available: https://research.google/pubs/borg-omega-and-kubernetes/
...
\bibitem{chatgpt2026} OpenAI, ``ChatGPT (Feb 23 version) [Large language model],'' 2026. Available: https://chat.openai.com/chat
\bibitem{gemini2026} Google, ``Gemini (Feb 23 version) [Large language model],'' 2026. Available: https://gemini.google.com/
\bibitem{psd_cloud_project} Auswahlenn, ``PSD\_Cloud\_Project,'' GitHub, 2026. Available: \url{https://github.com/Auswahlenn/PSD_Cloud_Project}
\end{thebibliography}
